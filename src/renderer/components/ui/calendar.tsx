...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-lg [--cell-radius:var(--radius-md)] [--cell-size:28px] bg-panel group/calendar in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
